...
juce::AudioProcessorValueTreeState::ParameterLayout
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("LowCut Slope","LowCut Slope",stringArray,0));
    layout.add(std::make_unique<juce::AudioParameterFloat>("HighCut Slope", "HighCut Slope", stringArray, 0));
